...
class StockReport::CLI
  ...
  def menu
    ...
    while input != "exit"
      ...
      puts "Enter 3 to list the prices of your stocks."
      puts "Enter 4 to add a new stock to your list."
      puts "Enter 5 to remove a stock from your list."
      puts "Enter 6 to erase your entire list."
